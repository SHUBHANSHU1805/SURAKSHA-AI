...
const MapPage = () => {
  ...
  useEffect(() => {
    ...
    toggleLayer(map.current, 'clusters', showMarkers);
    toggleLayer(map.current, 'cluster-count', showMarkers);
    toggleLayer(map.current, 'unclustered-point', showMarkers);
