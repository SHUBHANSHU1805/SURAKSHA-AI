...
// Get all FIRs with optional filters and pagination
export const getAllFIRs = async (filters = {}) => {
  try {
    ...
    // Attach pagination metadata directly to the array object
    firs.count = data.data?.count || 0;
    firs.page = data.data?.page || 1;
    firs.pages = data.data?.pages || 1;
    firs.limit = data.data?.limit || 100;
